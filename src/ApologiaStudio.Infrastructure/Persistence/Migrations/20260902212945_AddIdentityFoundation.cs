...
namespace ApologiaStudio.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddIdentityFoundation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "identity_administration_events",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_identity_administration_events", x => x.Id);
                    table.ForeignKey(
                        name: "FK_identity_administration_events_AspNetUsers_ActorUserId",
                        column: x => x.ActorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_identity_administration_events_AspNetUsers_TargetUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_identity_administration_events_ActorUserId",
                table: "identity_administration_events",
                column: "ActorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_identity_administration_events_TargetUserId_OccurredAtUtc",
                table: "identity_administration_events",
