...
internal static class DeDecretisRetrievalProfile
{
    public const string ProfileId =
        "de-decretis-retrieval-qwen3-embedding-4b-v1";

    public const string ChunkingStrategy =
    ...
    public const string OllamaBaseAddress =
        "http://127.0.0.1:11434";

    public static KnowledgeRetrievalProfile Definition { get; } =
        new(
            ProfileId,
            ChunkingStrategy,
            ChunkingVersion,
            ...
            MinimumPreferredChunkCharacters,
            EmbeddingProvider,
            EmbeddingModel,
            EmbeddingDimensions);
}
